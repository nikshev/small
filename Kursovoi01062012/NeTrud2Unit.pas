...
var
  NeTrud2Form: TNeTrud2Form;

implementation

{$R *.dfm}

procedure TNeTrud2Form.FormCreate(Sender: TObject);
var
...
procedure TNeTrud2Form.FormClose(Sender: TObject;
